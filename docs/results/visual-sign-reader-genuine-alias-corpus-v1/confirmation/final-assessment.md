...
See `docs\results\visual-sign-reader-genuine-alias-corpus-v1\confirmation` for manifest, commands, registry, cases, audits, replay artifacts, atlas, and handoff.
