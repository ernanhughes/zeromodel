...
The frozen confirmation corpus found 58 accepted wrong-row profile cases, representing 22 unique transformed wrong-row visual aliases.
...
`{"acceptance_rate": 0.49264705882352944, "accepted_case_count": 804, "accepted_wrong_row_count": 58, "accepted_wrong_row_per_1000_transformations": 35.53921568627451, "accepted_wrong_row_profile_cases_per_1000_transformations": 35.53921568627451, "action_changing_alias_rate": 0.05808080808080808, "action_equivalent_alias_rate": 0.08838383838383838, "duplicate_count": 256, "evidence_only_accepted_count": 408, "exact_row_accuracy_among_accepted": 0.8535353535353535, "failed_transformation_count": 0, "generated_case_count": 1632, "policy_action_accuracy_among_accepted": 0.9419191919191919, "policy_executed_accepted_count": 396, "reader_accepted_case_count": 804, "rejection_rate": 0.5073529411764706, "runtime_seconds": 0.644462, "transformation_case_count": 1632, "unique_matched_rows_receiving_aliases": 12, "unique_source_matched_row_pairs": 22, "unique_source_rows_producing_aliases": 8, "unique_transformed_observation_count": 1376, "unique_wrong_row_observation_count": 22, "wrong_row_accepted_rate": 0.14646464646464646, "wrong_row_different_action_count": 23, "wrong_row_profile_case_count": 58, "wrong_row_rate_among_all_accepts": 0.07213930348258707, "wrong_row_rate_among_policy_executes": 0.14646464646464646, "wrong_row_same_action_count": 35, "wrong_row_wilson_interval": {"count": 58, "denominator": 396, "high": 0.18468426403876537, "low": 0.11503842614654797}}`
...
35 wrong-row profile cases preserved the policy action while changing the addressed row.

## 19. Action-changing aliases
23 wrong-row profile cases changed the selected policy action.
...
See `docs\results\visual-sign-reader-genuine-alias-corpus-v1\smoke` for manifest, commands, registry, cases, audits, replay artifacts, atlas, and handoff.
