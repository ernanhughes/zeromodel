...
- **numpy_version**: 2.4.6
- **dev_samples_per_category**: 2
- **eval_samples_per_category**: 3
- **case_count**: 12
- **duration_seconds**: 213.815
- **command**: C:\Projects\zeromodel\examples\visual_transition_benchmark\compiler_run.py --dev-samples 2 --eval-samples 3 --output-dir docs/results/visual-transition-evidence-hardening/baseline/compiler-run
...
| arcade | tank_movement_magnitude | compiled | 3x4 exact_delta_over_position | 1.000 | 1.000 | 1.000 | 0.833 | 1.000 |
...
| warehouse | robot_movement_magnitude | compiled | 6x6 exact_delta_over_position | 1.000 | 1.000 | 0.797 | 1.000 | 1.000 |
